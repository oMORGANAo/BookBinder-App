...
function validatePasswordMatch() {
    const password1 = document.getElementById('change_password_form_plainPassword_first').value;
    const password2 = document.getElementById('change_password_form_plainPassword_second').value;
